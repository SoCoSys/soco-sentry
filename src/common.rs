...
pub fn check_software_update() {
    // SoCo Sentry: upstream disables the update check for rebranded ("custom")
    // clients; we re-enable it, pointed at our own endpoint (do_check_software_update).
...
pub async fn do_check_software_update() -> hbb_common::ResultType<()> {
    // SoCo Sentry: check our own endpoint instead of api.rustdesk.com.
    // version.php returns {"version":"1.4.9-1","url":"<release tag url>", ...}.
    let url = "https://sentry.socosystems.net/version.php";
