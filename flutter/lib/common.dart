...
class MyTheme {
  ...
  static const Color accent = Color(0xFF2E6B45);
  static const Color accent50 = Color(0x772E6B45);
  static const Color accent80 = Color(0xAA2E6B45);
  static const Color canvasColor = Color(0xFF212121);
  static const Color border = Color(0xFFCCCCCC);
  static const Color idColor = Color(0xFF4CAF7D);
  static const Color darkGray = Color.fromARGB(255, 148, 148, 148);
  static const Color cmIdColor = Color(0xFF21790B);
  static const Color dark = Colors.black87;
  static const Color button = Color(0xFF2E8B57);
...
Widget loadPowered(BuildContext context) {
  ...
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://www.socosystems.net'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
...
void checkUpdate() {
  if (!isWeb) {
    // SoCo Sentry: we ARE a custom client but self-host our own update feed
    // (version.php), so register the handler + trigger the check for us too.
    // Upstream skips custom clients, which is why the update card never showed.
